...
import type { AffirmationCategory, AffirmationSetPreview } from "@/types/affirmation.types";

export default function AffirmationSettings() {
  const { settings, updateSetting } = useSettings();

  const {data: affirmationSets, isLoading, isError} = useQuery({
      ...
      <div className="space-y-1">
        ...
        <div className="flex items-center gap-2">
          <Select
            ...
            onValueChange={(val: AffirmationCategory) => updateSetting("affirmationSet", val)}
          >
          ...
          <Dialog>
            <DialogTrigger asChild>
              <Button className="cursor-pointer" variant="ghost" size="sm">Preview</Button>
            </DialogTrigger>
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Affirmation Sets Preview</DialogTitle>
                <DialogDescription className="sr-only">Example affirmations</DialogDescription>
              </DialogHeader>
